...
import { addRole, changeRoleStatus, dataScope, delRole, getRole, listRole, updateRole, deptTreeSelect } from "@/api/role";
...
function reset() {
  ...
  if (proxy.$refs["roleRef"]) proxy.$refs["roleRef"].resetFields();
}
/** 添加角色 */
function handleAdd() {
  reset();
